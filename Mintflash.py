...
flashcards_by_phase = {
    "Phase 1: Core Structure & Personnel": [
        ...
        {"term": "Next: Select Phase 2 to learn about Pre-Snap Reads", "definition": "In Phase 2, we’ll dive into how safeties read formations, identify threats pre-snap, and communicate to keep the defense balanced.", "role": "All"}
    ],
    "Phase 2: Pre-Snap Reads": [
        ...
        {"term": "Next: Select Phase 3 to learn about Motion Adjustments", "definition": "In Phase 3, we’ll walk through how we react when the offense moves players pre-snap and how safeties shift responsibilities accordingly.", "role": "All"}
    ],
    "Phase 3: Motion Adjustments": [
        ...
        {"term": "Next: Select Phase 4 to learn about Coverage Responsibilities", "definition": "In Phase 4, you’ll review how FS and SS fit into different coverage schemes—man, zone, robber—and how to recognize route concepts.", "role": "All"}
    ],
    "Phase 4: Coverage Responsibilities": [
        ...
        {"term": "Next: Select Phase 5 to learn about Terminology", "definition": "In the final phase, we’ll reinforce key terms, checks, and concepts so you can recall them quickly on the field.", "role": "All"}
    ],
    "Phase 5: Terminology Recap": [
