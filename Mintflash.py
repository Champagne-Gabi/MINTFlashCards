...
phase = st.selectbox("Learning Phase:", [
...
# Define flashcards by learning phase with an end card for each phase
flashcards_by_phase = {
    "Phase 1: Core Structure & Personnel": [
        ...
        {"term": "Next: Select Phase 2 to learn about Pre-Snap Reads.", "definition": "You’ll get into how to read formations, track #2, and communicate as a unit before the snap.", "role": "All"}
    ],
    "Phase 2: Pre-Snap Reads": [
        ...
        {"term": "Next: Select Phase 3 to learn about Motion Adjustments.", "definition": "We’ll cover what happens when #2 or #3 shifts and how the secondary responds together.", "role": "All"}
    ],
    "Phase 3: Motion Adjustments": [
        ...
        {"term": "Next: Select Phase 4 to learn about Coverage Responsibilities.", "definition": "We’ll dig into your responsibilities in different coverage calls—man, zone, robber, and more.", "role": "All"}
    ],
    "Phase 4: Coverage Responsibilities": [
        ...
        {"term": "Next: Select Phase 5 to review key Terminology.", "definition": "Let’s finish strong with a recap of core language and checks you’ll need to communicate effectively.", "role": "All"}
    ],
    "Phase 5: Terminology Recap": [
